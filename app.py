...
<div class="main-header">
    ...
    <p>Tác giả: Chu Thị Hồng - Trường TH Quyết Tiến - ĐT: 081 6357 465</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Chu Thị Hồng - Trường TH Quyết Tiến - ĐT: 081 6357 465</div>", unsafe_allow_html=True)
